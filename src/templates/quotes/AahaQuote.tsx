...
export const AahaQuote: React.FC<TemplateProps> = ({ company, client, document }) => {
  ...
  return (
    <div className="bg-[#FAF9F6] text-amber-950 p-16 min-h-[800px] w-full max-w-4xl mx-auto font-serif relative shadow-xl">
      {/* Decorative Border */}
      ...
      <div className="flex justify-between items-end mb-16 px-4">
         <div>
            <p className="text-xs uppercase tracking-widest text-amber-700/60 mb-2">Prepared With Love For</p>
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b-2 border-amber-100 text-xs uppercase text-amber-900/60 tracking-widest">
              <th className="py-4 font-bold">Investment</th>
      ...
      <div className="flex justify-end mb-16 px-4">
         <div className="w-72 space-y-3 bg-amber-50 p-6 rounded-2xl">
            ...
            <div className="flex justify-between items-center text-xl font-bold text-amber-950 pt-4 border-t border-amber-200 font-sans">
               <span className="uppercase tracking-widest text-xs text-amber-900/80 font-serif font-bold">Grand Total</span>
      ...
      <div className="mt-auto text-center px-4">
         <p className="text-xs text-amber-800/60 leading-relaxed max-w-lg mx-auto italic">{company?.invoiceNotes || 'Thank you for considering us to capture your beautiful day.'}</p>
