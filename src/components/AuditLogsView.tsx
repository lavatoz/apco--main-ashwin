...
import { User, Clock, Search, AlertCircle, RefreshCw, Layers } from 'lucide-react';
   ...
   return (
      <div className="space-y-10 animate-ios-slide-up pb-20">
         <div className="flex justify-between items-center">
            ...
            <button onClick={handleRefresh} className="p-4 bg-zinc-900 border border-white/5 rounded-2xl text-zinc-500 hover:text-white transition-all shadow-xl active:scale-95">
