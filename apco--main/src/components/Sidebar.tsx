...
import {
  ...
  CloudRain, Cpu,
  CheckSquare, ShieldAlert, Archive
} from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isMobileOpen, setIsMobileOpen, userRole }) => {
  const [isSyncing, setIsSyncing] = useState(false);

  const menuItems = [
    { path: '/', label: 'Home', icon: LayoutDashboard, roles: ['Admin', 'Staff', 'Client'] },
    { path: '/directory', label: 'Directory', icon: Users, roles: ['Admin', 'Staff'] },
    { path: '/calendar', label: 'Schedule', icon: Calendar, roles: ['Admin', 'Staff'] },
    { path: '/tasks', label: 'Production', icon: CheckSquare, roles: ['Admin', 'Staff', 'Client'] },
    { path: '/vault', label: 'Vault', icon: Archive, roles: ['Admin', 'Staff'] },
    { path: '/finance', label: 'Ledger', icon: Wallet, roles: ['Admin', 'Staff', 'Client'] },
    { path: '/copilot', label: 'Copilot', icon: Sparkles, roles: ['Admin', 'Staff'] },
    { path: '/logs', label: 'Security', icon: ShieldAlert, roles: ['Admin', 'Staff'] },
    { path: '/system', label: 'Ecosystem', icon: Settings, roles: ['Admin', 'Staff'] },
  ];
