...
import { 
  LogOut, Image, Video, FileText, Link as LinkIcon, 
  Clock, CheckCircle2, Circle, Sparkles, User, Calendar, 
  MapPin, Heart, ArrowRight, Share2, MessageCircle, MessageSquare, FolderOpen, ExternalLink, ShieldAlert, X, Send, Database, UserCheck
} from 'lucide-react';
